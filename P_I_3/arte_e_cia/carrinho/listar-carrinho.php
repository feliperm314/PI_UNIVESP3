...
echo '
              ...
              $id_carrinho = $dados[$i]['id'];
                        ...
                        echo '  <div class="cart-inline-item">
                           ...
                           <a class="text-success" href="" onclick="adicionais('.$id_produto.','.$id_carrinho.')">
                           <span> <i class="fas fa-plus"></i> Adicionais 
                           </a>
                           </span>';
                           if($sabor_adc == 'Sim'){
                           echo '<a class="ml-2 text-danger" href="" onclick="sabores('.$id_carrinho.')">
                           <span> <i class="fas fa-plus text-danger"></i> Escolher Sabores 
                           </a>
                           </span>';
                         }
