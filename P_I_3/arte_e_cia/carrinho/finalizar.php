...
// Verifica se a chave 0 existe no array $dados
$valor_frete_bairro = isset($dados[0]['valor']) ? $dados[0]['valor'] : null;
...
// Verifica se a chave 'cartao' existe no array $dados[0]
$cartoes = isset($dados[0]['cartao']) ? $dados[0]['cartao'] : null;
$cartoes = $cartoes + 1;
