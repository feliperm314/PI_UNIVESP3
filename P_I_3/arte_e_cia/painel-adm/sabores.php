...
<div class="container ml-2 mr-2">
	<nav class="navbar navbar-expand navbar-white navbar-light">
		...
		<a id="btn-novo" type="button" class="btn btn-primary" href="index.php?acao=<?php echo $pagina ?>&funcao=novo">Novo Sabor</a>
		...
		<div class="modal-content">
			<div class="modal-header">
				<?php if(@$_GET['funcao']=='editar'){
					...
					$id = @$_GET['id'];
					$res = $pdo->query("SELECT * from sabores where id = '$id'");
			...
			<div class="modal-body">
				...
				<form id="<?php echo $form ?>" method="post">
					...
					<div class="form-group">
						...
						<label for="exampleFormControlInput1">Valor <small>(Acréscimo do valor ao valor da pizza)</small></label>
						<input type="text" class="form-control" id="valor" placeholder="Valor Adicional" name="valor" value="<?php echo @$valor ?>" required>
					</div>
