  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
       ...
       <li class="nav-item d-none d-sm-inline-block">
        <a href="index.php?acao=<?php echo $item7 ?>" class="nav-link <?php echo $item7ativo ?>">Adicionais</a>
      </li>

       <li class="nav-item d-none d-sm-inline-block">
        <a href="index.php?acao=<?php echo $item8 ?>" class="nav-link <?php echo $item8ativo ?>">Sabores</a>
      </li>

      <li class="nav-item d-none d-sm-inline-block">
        <a href="index.php?acao=<?php echo $item9 ?>" class="nav-link <?php echo $item9ativo ?>">Pedidos</a>
      </li>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="index.php?acao=<?php echo $item7 ?>" class="nav-link <?php echo $item7ativo ?>">
           ...
           <li class="nav-item">
            <a href="index.php?acao=<?php echo $item8 ?>" class="nav-link <?php echo $item8ativo ?>">
           ...
           <li class="nav-item">
            <a href="index.php?acao=<?php echo $item9 ?>" class="nav-link <?php echo $item9ativo ?>">
