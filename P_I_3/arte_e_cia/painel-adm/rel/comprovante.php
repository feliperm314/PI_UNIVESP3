...
$cep = $dados[0]['cep']; */
$nome_cliente = isset($dados[0]['nome']) ? $dados[0]['nome'] : '';
$rua = isset($dados[0]['rua']) ? $dados[0]['rua'] : '';
$numero = isset($dados[0]['numero']) ? $dados[0]['numero'] : '';
$bairro = isset($dados[0]['bairro']) ? $dados[0]['bairro'] : '';
$cidade = isset($dados[0]['cidade']) ? $dados[0]['cidade'] : '';
$estado = isset($dados[0]['estado']) ? $dados[0]['estado'] : '';
$cep = isset($dados[0]['cep']) ? $dados[0]['cep'] : '';
?>
