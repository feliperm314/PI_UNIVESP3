			...
			<div class="modal-body">
				...
				<form id="<?php echo $form ?>" method="post">
					...
					<div class="form-group">
						...
						<label for="exampleFormControlInput1">Valor<small>(Se for taxa por bairro)</small></label>
						<input type="text" class="form-control" id="valor" placeholder="Insira o Valor se Precisar" name="valor" value="<?php echo @$valor ?>" required>
					</div>
