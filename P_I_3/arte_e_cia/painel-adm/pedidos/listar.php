...
echo '
		<tr class="'.$classe.'">
			...
			<td>
				...
				<a title="Gerar Comprovante" href="rel/comprovante.php?id='.$id.'" target="_blank"><i class="fas fa-clipboard-list '.$classe.' ml-1"></i></a>


				<a title="Excluir Pedido" href="index.php?acao='.$pagina.'&funcao=excluir&id='.$id.'"><i class="far fa-trash-alt '.$classe.'"></i></a>
