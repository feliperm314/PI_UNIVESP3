				...
				<div class="form-group">
					...
					<textarea maxlength="600" class="form-control" id="descricao_longa" name="descricao_longa"><?php echo @$descricao_longa ?></textarea>
						...
						<div class="form-group form-check">
							...
							<input <?php echo @$checked ?> type="checkbox" class="form-check-input" id="exampleCheck1" name="adicional" value="Sim">
							<label class="form-check-label" for="exampleCheck1">Pizza (Possibilitar dois Sabores?)</label>
						</div>
