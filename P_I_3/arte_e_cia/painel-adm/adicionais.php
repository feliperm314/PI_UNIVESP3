...
<div class="container ml-2 mr-2">
	<nav class="navbar navbar-expand navbar-white navbar-light">
		...
		<a id="btn-novo" type="button" class="btn btn-primary" href="index.php?acao=<?php echo $pagina ?>&funcao=novo">Novo Adicional</a>
		...
		<div class="modal-content">
			<div class="modal-header">
				<?php if(@$_GET['funcao']=='editar'){
					...
					$id = @$_GET['id'];
					$res = $pdo->query("SELECT * from adicionais where id = '$id'");
					$dados = $res->fetchAll(PDO::FETCH_ASSOC);
					$nome = $dados[0]['nome'];
					$valor = $dados[0]['valor'];
					$categoria = $dados[0]['id_cat'];
