            ...
            <div class="col-md-10 col-lg-7 col-xl-6">
              ...
              <div class="tabs-custom tabs-horizontal tabs-line" id="tabs-4">
                ...
                <ul class="nav nav-tabs">
                  ...
                  <li class="nav-item" role="presentation"><a class="nav-link" href="#tabs-4-2" data-toggle="tab">Nosos Valores</a></li>
              ...
              <div class="owl-carousel owl-modern" data-items="1" data-stage-padding="15" data-margin="30" data-dots="true" data-animation-in="fadeIn" data-animation-out="fadeOut" data-autoplay="true">
                ...
                <article class="quote-lisa">
                  <div class="quote-lisa-body"><a class="quote-lisa-figure" href="#"><img class="img-circles" src="images/hugo.jpeg" alt="" width="100" height="100"/></a>
                    <div class="quote-lisa-text">
                      <p class="q">Sempre sou bem atendido e as pizzas são saborosas.</p>
                    </div>
                    <h5 class="quote-lisa-cite"><a href="#">Hugo Silva</a></h5>
                ...
                <article class="quote-lisa">
                  <div class="quote-lisa-body"><a class="quote-lisa-figure" href="#"><img class="img-circles" src="images/user-17-100x100.jpg" alt="" width="100" height="100"/></a>
                    <div class="quote-lisa-text">
                      <p class="q">Pizza muito boa!</p>
                    </div>
                    <h5 class="quote-lisa-cite"><a href="#">João de Oliveira</a></h5>
                    <p class="quote-lisa-status">Cliente Satisfeito</p>
                  </div>
                </article>
                <!-- Quote Lisa-->
                <article class="quote-lisa">
                  <div class="quote-lisa-body"><a class="quote-lisa-figure" href="#"><img class="img-circles" src="images/user-18-100x100.jpg" alt="" width="100" height="100"/></a>
                    <div class="quote-lisa-text">
                      <p class="q">A pizza é boa e a entrega é rápida!</p>
                    </div>
                    <h5 class="quote-lisa-cite"><a href="#">Marco Pereira</a></h5>
                    <p class="quote-lisa-status">Cliente Satisfeito</p>
                  </div>
                </article>
              </div>
