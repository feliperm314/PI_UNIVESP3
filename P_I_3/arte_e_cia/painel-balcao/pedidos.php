...
$res = $pdo->query("SELECT * from vendas");
$dados = $res->fetchAll(PDO::FETCH_ASSOC);
$total_ped = @count($dados);

echo "<meta HTTP-EQUIV='refresh' CONTENT='$tempo_atualizacao_tela_pedidos;URL=index.php?acao=pedidos&total_ped=$total_ped'>"; 

if(@$_GET['total_ped'] != @$total_ped){
